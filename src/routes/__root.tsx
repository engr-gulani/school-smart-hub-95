...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Greenfield College · School Management Portal" },
      {
        name: "description",
        content:
          "Modern high school management portal for results, report cards, teachers, students, classes and broadsheets.",
      },
      { property: "og:title", content: "Greenfield College · School Management Portal" },
      {
        property: "og:description",
        content: "Automate student results, report cards and broadsheets in one modern portal.",
      },
